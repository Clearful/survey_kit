...
class _MultipleChoiceAutoCompleteAnswerViewState extends State<MultipleChoiceAutoCompleteAnswerView> {
  ...
  void initState() {
    ...
    if (widget.questionStep.randomizeOrder) {
      _multipleChoiceAnswer.textChoices.toList().shuffle();
    }
          ...
          Column(
            children: [
              ...
              ..._multipleChoiceAnswer.textChoices
                  ...
                  .toList(),
              ..._selectedChoices
                  .where((element) => !_multipleChoiceAnswer.textChoices.contains(element))
                  .map(
                    (TextChoice tc) => SelectionListTile(
                      text: tc.text,
                      onTap: () => onChoiceSelected(tc),
  ...
  Widget build(BuildContext context) {
    return Autocomplete<TextChoice>(
      ...
      optionsBuilder: (textEditingValue) {
        ...
        return suggestions.where((element) => element.text.toLowerCase().contains(textEditingValue.text.toLowerCase()));
      },
      onSelected: onSelected,
    );
  }
                  ...
                  child: Builder(builder: (BuildContext context) {
                    ...
                    return Container(
                      ...
                      child: Row(
                        ...
                        children: [Text(option.text), if (selectedChoices.contains(option)) Icon(Icons.done)],
                      ),
                    );
                  }),
                );
